...
VALUES
  ('ALT-DEV-2001', 'NEW_ORDER', 'ORD-DEV-1001', 'mechanical keyboard', 'dev', 'order-api', '2026-04-16 09:00:05'),
  ('ALT-DEV-2002', 'NEW_ORDER', 'ORD-DEV-1002', 'usb-c dock', 'dev', 'order-api', '2026-04-16 09:15:04'),
  ('ALT-DEV-2003', 'NEW_ORDER', 'ORD-DEV-1003', 'monitor arm', 'dev', 'order-api', '2026-04-16 09:30:06')
ON CONFLICT (id) DO NOTHING;
